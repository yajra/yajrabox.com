        ...
        <div class="max-w-screen-xl mx-auto px-5 flex items-center justify-between">
            <div class="flex-1">
                <a href="/" class="inline-flex items-center">
                    <img class="sm:block" src="{{ asset('img/logotype.min.svg') }}" alt="{{ config('app.name') }}" width="114"
                         height="29">
                </a>
            </div>
            ...
            <div class="flex-1 flex items-center justify-end">
                <x-button.secondary href="https://github.com/yajra" class="hidden lg:ml-4 lg:inline-flex">Github</x-button.secondary>
                <button
    ...
    >
        ...
        >
            <div class="relative h-full w-full py-8 px-5 bg-white pointer-events-auto overflow-y-auto">
                <ul>
                    <li><a class="block w-full py-2" href="https://github.com/yajra">Github</a></li>
