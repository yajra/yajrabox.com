                    ...
                    <template x-for="(hit, index) in hits" :key="index" hidden>
                        <div>
                            <a
                                ...
                                :href="'/docs/' + window.package + '/' + window.version + '/' + hit.link"
                            ...
                            >
                                ...
                                <div class="mt-2">
                                    ...
                                    <div x-show="hit._highlightResult.h2" class="text-sm">
                                        > <span x-html="hit._highlightResult.h2 ? hit._highlightResult.h2.value : ''"></span>
                                    </div>

                                    <div x-show="hit._highlightResult.h3" class="text-sm">
                                        > <span x-html="hit._highlightResult.h3 ? hit._highlightResult.h3.value : ''"></span>
                                    </div>

                                    <div x-show="hit._highlightResult.h4" class="text-sm">
                                        > <span x-html="hit._highlightResult.h4 ? hit._highlightResult.h4.value : ''"></span>
                                    </div>

                                    <div x-show="hit._highlightResult.content" class="text-sm">
                                        > <span x-html="hit._highlightResult.content ? hit._highlightResult.content.value : ''"></span>
                                    </div>
                                </div>
                            </a>
                        </div>
